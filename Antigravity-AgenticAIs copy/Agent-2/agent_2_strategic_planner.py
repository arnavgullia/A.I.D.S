...
class StrategicPlanner:
    ...
    def __init__(self, api_key: str = None, model: str = "gemini-2.5-flash-lite"):
        ...
        # Subscribe to Agent 1 assessments so Agent 2 can react to intel
        self.last_assessment = None
        try:
            def _on_assessment(topic, payload):
                # store last assessment for use during planning
                self.last_assessment = payload

            subscribe("agent_1/assessment", _on_assessment)
        except Exception:
            pass
